...
36. グループ分けを行うプログラムを作成せよ．連番をランダムシャッフルして，上から順番に班番号を割り当てる．クラス人数と，1班の人数は引数で指定すること．

37. グループ分けを行うプログラムを作成せよ．名票はmeibo.csvである．
カラムは次のようになっている．「出席番号,学籍番号,氏名,フリガナ,出席有無」
例えば，「1,j12401,木更津　太郎,キサラヅ　タロウ,1」となる．
この名票から指定した人数でグループを作成する．
